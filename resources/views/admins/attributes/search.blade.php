                    ...
                    @foreach ($attributes as $index => $attribute)
                        ...
                        <tr class="text-dark">
                            ...
                            <td>
                                ...
                                @else
                                    <i class="fas fa-times tet-danger"></i>
                                @endif
                            </td>
                            <td>
                            ...
                            <td class="text-center" width="15%">
                                <a href="{{ url('admin/master/attribute') }}/{{ $attribute->id }}" id="btn-view" data-id="{{ $attribute->id }}" class="my-2 btn btn-warning" data-toggle="tooltip" data-placement="top" title="View Data">
                                    <i class="text-white mdi mdi-eye"></i>
                                </a>
                                <a href="{{ url('admin/master/attribute') }}/{{ $attribute->id }}/options" id="btn-options" data-id="{{ $attribute->id }}" class="my-2 btn btn-warning" data-toggle="tooltip" data-placement="top" title="Options">
                                    <i class="fas fa-toolbox"></i>
                                </a>
                                <button id="btn-delete" data-id="{{ $attribute->id }}" class="my-2 btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete Data">
